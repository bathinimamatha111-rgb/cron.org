...
import { Clock01Icon, UserIcon, Mail01Icon, LockPasswordIcon } from '@hugeicons/core-free-icons'
      ...
      <Card className="w-full max-w-md glass relative z-10 border-white/10 shadow-2xl">
        <CardHeader className="text-center pb-8 pt-10">
          ...
          <div className="space-y-1">
            <CardTitle className="text-3xl font-black tracking-tight text-white">Join CronJob</CardTitle>
            <p className="text-sm text-white/40 font-medium">Start automating your tasks in minutes</p>
          </div>
        </CardHeader>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="relative group">
                <HugeiconsIcon icon={UserIcon} className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-indigo-400 transition-colors" />
                <Input
                  type="text"
